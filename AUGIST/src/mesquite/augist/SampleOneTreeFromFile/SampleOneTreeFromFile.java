package mesquite.augist.SampleOneTreeFromFile;
...
//TODO: GOT SOME RNG CHANGES TO MAKE - ONLY PULLING OUT VERY FIRST TREE...

/*Almost identical to it's superclass, but only allows a single tree to be read from file.*/
public class SampleOneTreeFromFile extends TreeSource implements MesquiteListener, PathHolder {
	int currentTree=0;
...
//	FIleCheckThread fileCheckingThread = null;
	...
	MesquiteCommand fileGrewCommand, fileChangedCommand;//TODO: could be omitted?
	...
	protected int numTreesToSample = 1; // MesquiteInteger.unassigned;
	protected int numStartTreesToIgnore = 0; //TODO: consider getting rid of this
	String highestSuccessfulDescription = null;

	/*.................................................................................................................*/
	public String getName() {
		return "Sample One Tree from File";
	}
	/*.................................................................................................................*/
...
//			return sorry("Tree manager not found.");
	...
	public boolean setFilePath(String path){
		...
		MesquiteFile treeFile = fCoord.getNEXUSFileForReading(path, "Choose Tree File");
		if (treeFile != null) {
			if (file !=null) {
				file.closeReading();
				file.dispose();
	...
	/*.................................................................................................................*/
	protected boolean additionStartJobItems(){//TODO: omit
	...
	protected boolean getSampleTrees(){
		return true; //TODO: changed from false May.30.2012 oliver
	}
	/*.................................................................................................................*/
	...
	/*.................................................................................................................*/
	protected void setTreesToSample(int numTreesToSample) {//TODO:  Can be much simpler, since only want 1
	...
	/*.................................................................................................................*/
	protected String reportTreesSampled(){ //TODO: this can be omitted
...
//			fileCheckingThread.setPath(file.getPath());
	...
	public boolean processFile(){ // Was private
		...
		while (!StringUtil.blank(s=file.getNextCommand(status, null, !(getSampleTrees()&&treesEncountered)))) {
			...
			if (status.getValue() == 2) { //end of block reached
				...
				if (getSampleTrees() && treesToSample!=null) {
					...
					if (MesquiteInteger.isCombinable(numTreesToSample))//TODO: omit numTreesToSample should always equal 1
						setTreesToSample(numTreesToSample);
				}
...
//			fileCheckingThread.start();
	...
	public void fileModified(long longer){//TODO: probably could be omitted
