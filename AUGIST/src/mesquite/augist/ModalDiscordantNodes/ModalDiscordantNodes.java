package mesquite.augist.ModalDiscordantNodes;
...
public class ModalDiscordantNodes extends NumbersForNodes{
	...
	public boolean startJob(String arguments, Object condition,	boolean hiredByName) {
		...
		ageThreshold = new MesquiteDouble(0.0);
...
//				parametersChanged();
	...
	/*.................................................................................................................*/
	public void calculateNumbers(Tree speciesTree, NumberArray result, MesquiteString resultString) {
	...
	private void visitNodes(Tree speciesTree, int spTreeNode, double depthThreshold, NumberArray result){

		if(speciesTree.nodeExists(spTreeNode)){
			//For reporting purposes
			if(nodeCheck == 0){
				log("Checking nodes of " + speciesTree.getName());
			}
			nodeCheck++;
			if(speciesTree.numberOfInternalsInClade(speciesTree.getRoot()) > 100){
				if(nodeCheck % 10 == 0){
					log("" + nodeCheck);
				} else log(".");
			}
...
//			if(speciesTree.nodeIsInternal(spTreeNode) && speciesTree.tallestPathAboveNode(spTreeNode) >= depthThreshold){
				...
				while(geneTreeCount < geneTreeVector.getNumberOfTrees() && (double)concordantCount < (double)geneTreeVector.getNumberOfTrees()/2){
	...
	public String getName() {
		return "Modal Discordant Nodes (binary)";
	}
	/*.................................................................................................................*/
